...
void APIENTRY GLAPI_PREFIX(_dispatch_stub_697)(GLfloat x, GLfloat y, GLfloat z, GLfloat width, GLfloat height);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_698)(const GLfloat *coords);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_699)(GLint x, GLint y, GLint z, GLint width, GLint height);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_700)(const GLint *coords);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_701)(GLshort x, GLshort y, GLshort z, GLshort width, GLshort height);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_702)(const GLshort *coords);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_703)(GLfixed x, GLfixed y, GLfixed z, GLfixed width, GLfixed height);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_704)(const GLfixed *coords);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_705)(GLenum type, GLsizei stride, const GLvoid *pointer);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_706)(GLenum pname, GLfloat *params);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_707)(GLenum pname, GLint *params);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_708)(GLenum pname, GLfloat param);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_709)(GLenum pname, const GLfloat *params);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_710)(GLenum pname, GLint param);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_711)(GLenum pname, const GLint *params);
GLbitfield APIENTRY GLAPI_PREFIX(_dispatch_stub_712)(GLfixed *mantissa, GLint *exponent);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_713)(GLclampf value, GLboolean invert);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_714)(GLenum pattern);
...
void APIENTRY GLAPI_PREFIX(_dispatch_stub_749)(GLenum mode);
...
void APIENTRY GLAPI_PREFIX(_dispatch_stub_791)(const GLenum *mode, const GLint *first, const GLsizei *count, GLsizei primcount, GLint modestride);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_792)(const GLenum *mode, const GLsizei *count, GLenum type, const GLvoid * const *indices, GLsizei primcount, GLint modestride);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_793)(GLsizei n, const GLuint *fences);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_794)(GLuint fence);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_795)(GLsizei n, GLuint *fences);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_796)(GLuint fence, GLenum pname, GLint *params);
GLboolean APIENTRY GLAPI_PREFIX(_dispatch_stub_797)(GLuint fence);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_798)(GLuint fence, GLenum condition);
...
void APIENTRY GLAPI_PREFIX(_dispatch_stub_880)(GLenum face);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_881)(GLuint array);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_882)(GLsizei n, const GLuint *arrays);
GLAPI void APIENTRY GLAPI_PREFIX(DeleteVertexArrays)(GLsizei n, const GLuint *arrays);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_883)(GLsizei n, GLuint *arrays);
GLboolean APIENTRY GLAPI_PREFIX(_dispatch_stub_884)(GLuint array);
...
void APIENTRY GLAPI_PREFIX(_dispatch_stub_893)(GLenum func, GLclampx ref);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_894)(GLclampx red, GLclampx green, GLclampx blue, GLclampx alpha);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_895)(GLclampx depth);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_896)(GLenum plane, const GLfixed *equation);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_897)(GLfixed red, GLfixed green, GLfixed blue, GLfixed alpha);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_898)(GLclampx zNear, GLclampx zFar);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_899)(GLenum pname, GLfixed param);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_900)(GLenum pname, const GLfixed *params);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_901)(GLfixed left, GLfixed right, GLfixed bottom, GLfixed top, GLfixed zNear, GLfixed zFar);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_902)(GLenum plane, GLfixed *equation);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_903)(GLenum pname, GLfixed *params);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_904)(GLenum light, GLenum pname, GLfixed *params);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_905)(GLenum face, GLenum pname, GLfixed *params);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_906)(GLenum target, GLenum pname, GLfixed *params);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_907)(GLenum coord, GLenum pname, GLfixed *params);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_908)(GLenum target, GLenum pname, GLfixed *params);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_909)(GLenum pname, GLfixed param);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_910)(GLenum pname, const GLfixed *params);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_911)(GLenum light, GLenum pname, GLfixed param);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_912)(GLenum light, GLenum pname, const GLfixed *params);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_913)(GLfixed width);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_914)(const GLfixed *m);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_915)(GLenum face, GLenum pname, GLfixed param);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_916)(GLenum face, GLenum pname, const GLfixed *params);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_917)(const GLfixed *m);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_918)(GLenum target, GLfixed s, GLfixed t, GLfixed r, GLfixed q);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_919)(GLfixed nx, GLfixed ny, GLfixed nz);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_920)(GLfixed left, GLfixed right, GLfixed bottom, GLfixed top, GLfixed zNear, GLfixed zFar);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_921)(GLenum pname, GLfixed param);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_922)(GLenum pname, const GLfixed *params);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_923)(GLfixed size);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_924)(GLfixed factor, GLfixed units);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_925)(GLfixed angle, GLfixed x, GLfixed y, GLfixed z);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_926)(GLclampx value, GLboolean invert);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_927)(GLfixed x, GLfixed y, GLfixed z);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_928)(GLenum target, GLenum pname, GLfixed param);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_929)(GLenum target, GLenum pname, const GLfixed *params);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_930)(GLenum coord, GLenum pname, GLint param);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_931)(GLenum coord, GLenum pname, const GLfixed *params);
...
void APIENTRY GLAPI_PREFIX(_dispatch_stub_934)(GLfixed x, GLfixed y, GLfixed z);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_935)(GLenum plane, const GLfloat *equation);
...
void APIENTRY GLAPI_PREFIX(_dispatch_stub_937)(GLenum plane, GLfloat *equation);
...
void APIENTRY GLAPI_PREFIX(_dispatch_stub_939)(GLclampd zmin, GLclampd zmax);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_940)(GLenum modeRGB, GLenum modeA);
...
void APIENTRY GLAPI_PREFIX(_dispatch_stub_958)(GLint srcX0, GLint srcY0, GLint srcX1, GLint srcY1, GLint dstX0, GLint dstY0, GLint dstX1, GLint dstY1, GLbitfield mask, GLenum filter);
...
void APIENTRY GLAPI_PREFIX(_dispatch_stub_959)(GLenum target, GLenum pname, GLint param);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_960)(GLenum target, GLintptr offset, GLsizeiptr size);
...
void APIENTRY GLAPI_PREFIX(_dispatch_stub_1018)(GLenum target, GLenum pname, GLvoid **params);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_1019)(GLenum target, GLsizei length, GLvoid *pointer);
...
void APIENTRY GLAPI_PREFIX(_dispatch_stub_1027)(GLenum frontfunc, GLenum backfunc, GLint ref, GLuint mask);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_1028)(GLenum target, GLuint index, GLsizei count, const GLfloat *params);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_1029)(GLenum target, GLuint index, GLsizei count, const GLfloat *params);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_1030)(GLuint id, GLenum pname, GLint64EXT *params);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_1031)(GLuint id, GLenum pname, GLuint64EXT *params);
